<div class="px-4 mb-12 relative w-full md:w-4/12">
    <div
        ...
        <div class="pt-8 pb-16 px-10 flex-auto relative overflow-hidden">
            <h4 class="text-xl font-bold mt-0 mb-2 truncate">{{ $company->name }}</h4>
            <p class="text-blueGray-500 leading-relaxed text-justify">{{ substr($company->short_description, 0, 156) }} ...</p>
            <div
